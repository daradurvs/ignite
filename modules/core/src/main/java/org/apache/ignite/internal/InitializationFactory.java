...
public interface InitializationFactory {
     ...
     * @throws InvocationTargetException - if {@param clazz} that declares the underlying constructor represents an
     * abstract class.
     * @throws InstantiationException - if {@param clazz} that declares the underlying constructor represents an
     * abstract class.
     */
